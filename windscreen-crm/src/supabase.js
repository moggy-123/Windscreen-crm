...
const jobToDb = j => ({
  id: j.id, customer_id: j.customerId, driver_name: j.driverName, driver_phone: j.driverPhone || null, contact_name: j.contactName || null, vehicle_id: j.vehicleId || null,
...
const jobFromDb = r => ({
  id: r.id, customerId: r.customer_id, driverName: r.driver_name, driverPhone: r.driver_phone || "", contactName: r.contact_name, vehicleId: r.vehicle_id,
