...
const BUILD_NUMBER = "B61 · 18 Jul 2026";
        ...
        {repairs.map((r, idx) => (
          <div key={r.id} style={{ background:"#F8FAFC", border:"1px solid #F3F4F6", borderRadius:10, padding:12, marginBottom:8 }}>
            ...
            <div style={{ display:"flex", gap:8 }}>
              ...
              <div style={{ flex:1 }}>
                <Select value={r.position} onChange={v => updateRepair(r.id, "position", v)} options={["Top","Top Right","Top Left","Top Centre","Centre","Bottom","Bottom Right","Bottom Left","Bottom Centre"]} placeholder="Position…" />
              </div>
            </div>
