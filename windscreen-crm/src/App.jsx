...
const BUILD_NUMBER = "B80 · 18 Jul 2026";
      ...
      <Card style={{ marginBottom:16 }}>
        ...
        {Array.isArray(stops) && (
          <>
            ...
            {routeResult === "error" && <p style={{ fontSize:13, color:"#DC2626", textAlign:"center", margin:0 }}>Couldn't find one of those postcodes — check they're valid, or add the mileage manually.</p>}
