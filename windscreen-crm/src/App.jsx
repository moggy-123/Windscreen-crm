...
const BUILD_NUMBER = "B81 · 18 Jul 2026";
...
<div style="max-width:700px;margin:0 auto;padding:24px;background:#fff;">
  ...
  <div style="font-size:12px;color:${invoice.paid?"#059669":"#D97706"};font-weight:700;margin-top:10px;">${invoice.paid ? `✓ Paid${invoice.paidDate ? " " + fmtDate(invoice.paidDate) : ""}` : "Payment due within 30 days"}</div>
