...
const BUILD_NUMBER = "B75 · 18 Jul 2026";
  ...
  return (
    <div>
      ...
      {overdueTradeCustomers.length > 0 && (
        <div onClick={() => setView({ screen:"settings" })} style={{ background:"#DC2626", color:"#fff", borderRadius:10, padding:"12px 14px", marginBottom:20, cursor:"pointer", display:"flex", alignItems:"center", gap:10 }}>
